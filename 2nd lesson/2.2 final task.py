...
Алгоритм проходит по входным данным в цикле. Встречая операд, добавляет его в стек, встречая символ операции, достает из
...
-- ID успешной посылки --
https://contest.yandex.ru/contest/22781/run-report/116440122/
"""
